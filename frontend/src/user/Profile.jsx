                    ...
                    <div className="flex lg:flex-row flex-col items-center lg:py-8 lg:space-x-8">
                        ...
                        <div className="lg:w/8/12 flex-1 flex flex-col lg:items-start items-center">
                            ...
                            <div className="flex font-semibold mb-3 space-x-2  dark:text-gray-10">
                                <Link href="#">Travailing</Link> , <Link href="#">Sports</Link> ,<Link href="#">Movies</Link>
                            </div>
                            <div className="capitalize flex font-semibold space-x-3 text-center text-sm my-2">
                                {isAuthenticated().id && isAuthenticated().id === users.id ? (
                                    <>
                                        ...
                                        <Link className="bg-pink-500 shadow-sm p-2 pink-500 px-6 rounded-md text-white hover:text-white hover:bg-pink-600" to={`/user/edit/${users._id}`}>
                                            Edit Profile
                                        </Link>
                                ...
                                {isAuthenticated().user && isAuthenticated().user.role === "admin" && (
                                    <div class="card mt-5">
                                        <div className="card-body">
                                            ...
                                            <Link className="btn btn-raised btn-success mr-5" to={`/user/edit/${users._id}`}>
                                                Edit Profile
                                            </Link>
                                            <DeleteUser userId={users._id} />
                                            <DeleteUser />
                                ...
                                <div>
                                    <Link href="#" className="bg-gray-300 flex h-12 h-full items-center justify-center rounded-full text-xl w-9 dark:bg-gray-700" aria-expanded="false">
                                    ...
                                    <div className="bg-white w-56 shadow-md mx-auto p-2 mt-12 rounded-md text-gray-500 hidden text-base dark:bg-gray-900 uk-drop" uk-drop="mode: click">
                                        <ul className="space-y-1">
                                            <li>
                                                <Link href="#" className="flex items-center px-3 py-2 hover:bg-gray-200 hover:text-gray-800 rounded-md dark:hover:bg-gray-700">
                                            ...
                                            <li>
                                                <Link href="#" className="flex items-center px-3 py-2 text-red-500 hover:bg-red-100 hover:text-red-500 rounded-md dark:hover:bg-red-600">
