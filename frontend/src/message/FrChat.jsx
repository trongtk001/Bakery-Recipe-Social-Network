        ...
        <div className="px-5 py-4 flex">                        
            <a href="/#" className="flex items-center space-x-3">
                <div className="w-10 h-10 rounded-full relative flex-shrink-0">
                    ...
                    <span className={`absolute border-2 border-white bottom-0 h-3 m-0.5 mb-6 block right-0 rounded-full shadow-md w-3 ${usersActive?.includes(active?.username) ? 'bg-green-500 ' : 'bg-dark-500'}`}></span>
                </div>
